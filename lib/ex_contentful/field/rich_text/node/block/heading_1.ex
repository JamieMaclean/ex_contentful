defmodule ExContentful.Field.RichText.Node.Heading1 do
  alias __MODULE__
  ...
  defstruct data: %{}, content: [], node_type: Constraints.blocks_mapping().heading_1
  ...
  defimpl ExContentful.Field.RichText.Node do
    ...
    def validate(%Heading1{content: content} = node) do
