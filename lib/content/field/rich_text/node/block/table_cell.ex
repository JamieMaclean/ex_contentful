defmodule ExContentful.Field.RichText.Node.TableCell do
  alias __MODULE__
  ...
  defstruct [:data, :content, node_type: Constraints.blocks_mapping().table_cell]
  ...
  defimpl ExContentful.Field.RichText.Node do
    ...
    def validate(%TableCell{content: content} = node) do
