defmodule ExContentful.Field.RichText.Node.Heading4 do
  alias __MODULE__
  ...
  defstruct data: %{}, content: [], node_type: Constraints.blocks_mapping().heading_4
  ...
  defimpl ExContentful.Field.RichText.Node do
    ...
    def validate(%Heading4{content: content} = node) do
